...
def demand_wihtout_input(path):
    ...
    fig2 = px.line(final_data,y ='Predicted_Demand', title="Monthly Future Demand 2020-2035",
...
def main():
    ...
    st.markdown('<h1>Predicting Agricultural Demand <img src="https://upload.wikimedia.org/wikipedia/en/thumb/0/05/Flag_of_Brazil.svg/640px-Flag_of_Brazil.svg.png" alt="Brazil Flag" width="40" style="vertical-align: middle;"> </h1>', unsafe_allow_html=True)
    st.markdown('<h2 style="color:#E6B437; display: inline-block;">DAP in Brazil  </h2>', unsafe_allow_html=True)
    col1, col2 = st.columns(2)
    with col1:
